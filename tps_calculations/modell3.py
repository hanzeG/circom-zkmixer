...
df = pd.read_csv('/Users/arafathshariff/zkp-solutions/tps_calculations/pricexrp.csv')
...
future_data = pd.DataFrame([[future_date.year, future_date.month, future_date.day, 10.0, 11.0, 9.0, np.nan]],
